    ...
    <>
        ...
        <div className="flex mt-10 max-w-screen-xl mx-auto">
            ...
            <div className="flex flex-col items-center text-center border border-zinc-600 rounded-md flex-1 p-4 m-2">
                ...
                <p className="text-zinc-400">Personalize seu próprio cartão de acordo com suas necessidades exatas de receitas e despesas.</p>
            </div>

            <div className="flex flex-col items-center text-center border border-zinc-600 rounded-md flex-1 p-4 m-2" >
                <img src="src/assets/coinicon.png" alt="" />
                <h1 className="font-bold text-2xl my-3">Sem taxa de pagamento</h1>
                <p className="text-zinc-400">Transfira seu pagamento para todo o mundo sem taxa de pagamento.</p>
            </div>

            <div className="flex flex-col items-center text-center border border-zinc-600 rounded-md flex-1 p-4 m-2">
                <img src="src/assets/purseicon.png" alt="" />
                <h1 className="font-bold text-2xl my-3">Tudo em um só lugar</h1>
                <p className="text-zinc-400">O lugar certo para guardar seus cartões de crédito e débito, cartões de embarque e muito mais.</p>
            </div>
        </div>
